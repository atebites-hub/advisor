...
grep -Fq 'Antigravity' "$repo_dir/README.md" && grep -Fq 'Copilot' "$repo_dir/README.md" ||
  fail "README omits Antigravity/Copilot as deferred gaps"
...
if rg -n 'atebites-hub/sol-advisor' \
  "$repo_dir/marketplace.json" \
